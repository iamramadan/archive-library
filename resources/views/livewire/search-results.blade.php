                ...
                {{-- @dd($notes) --}}
                    @forelse ($notes['data'] as $note)
                        <div  class="result-card p-4 rounded-lg">
                            ...
                            <a href="{{route('pages.note',['id'=>$note['id']])}}" class="result-title text-xl font-medium mb-1 inline-block">{!!highlightWord($note['title'],$query)!!}</a>
            ...
            @endif
                ...
                @case('questionaires')
                    ...
                    @empty
                        ...
                        <a href="{{route('create.questionaires')}}" class="inline-block mt-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-full hover:bg-blue-700 transition">
                            Request Questionnaire
                        </a>
                        </div>
                    @endforelse
                @if (count($questionaires['data']))
                ...
                @case('resources')
                    ...
                    @empty
                        <div class="max-w-md mx-auto mt-10 p-6 bg-white rounded-2xl shadow-md flex flex-col items-center text-center space-y-4">
                            ...
                            <a href="{{route('create.resources')}}" class="inline-block mt-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-full hover:bg-blue-700 transition">
                                Create Resource
                            </a>
                        </div>
                    @endforelse
            @if (count($resources['data']))
